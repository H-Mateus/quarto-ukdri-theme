...
## Thanks for listening {.final-slide background-image="_extensions/H-Mateus/ukdri/final_slide.png"}

Replace `profile.png` with the path to the pictures you'd like to use.

::: columns
::: {.column width="20%"}
![[Name Porsition/Role]{style="color:white;"}](_extensions/H-Mateus/ukdri/profile.avif){.profile-item .custom-box width="75%"}
:::
...
![](_extensions/H-Mateus/ukdri/260330-162255.avif){.absolute top=20 right=0 width=30%}

![](_extensions/H-Mateus/ukdri/260330-162358.avif){.absolute top=120 right=205 width=10%}
